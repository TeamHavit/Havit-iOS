        ...
        Task {
            do {
                ...
                let targetContents = try await targetContents {
                    ...
                    self.targetContent = TargetContent(title: targetContents.ogTitle,
                                                       description: targetContents.ogDescription,
                                                       ogImage: targetContents.ogImage,
                                                       ogUrl: targetContents.ogURL,
                                                       contentUrl: self.shareObjectUrl)
                }
